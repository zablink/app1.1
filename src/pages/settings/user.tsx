...
import { FiUser, FiMail, FiLock, FiImage, FiUpload, FiSave, FiEdit, FiStore } from 'react-icons/fi';
      ...
      >
        ...
        <div className="p-6 border border-gray-200 rounded-lg bg-blue-50">
          <h2 className="text-2xl font-semibold text-blue-700 mb-4 flex items-center">
            <FiStore className="mr-2" /> ต้องการเป็นร้านค้า?
          </h2>
          ...
          <Link href="/register-shop">
            ...
            >
              <FiStore className="mr-2" /> ลงทะเบียนร้านค้า
            </motion.a>
          </Link>
        </div>
      </motion.div>
